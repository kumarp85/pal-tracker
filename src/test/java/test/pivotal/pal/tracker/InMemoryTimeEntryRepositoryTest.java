...
public class InMemoryTimeEntryRepositoryTest {
    ...
    public void create() throws Exception {
        ...
        System.out.println(createdTimeEntry.getId()+" : "+ createdTimeEntry.getProjectId()+" : "+  createdTimeEntry.getUserId()+" : "+  createdTimeEntry.getDate()+" : "+  createdTimeEntry.getHours());
        System.out.println(expected.getId()+" : "+ expected.getProjectId()+" : "+  expected.getUserId()+" : "+  expected.getDate()+" : "+  expected.getHours());
